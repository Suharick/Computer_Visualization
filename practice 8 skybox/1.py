...
def init():
	...
	zoom   = 0.5
	filled = 1
	texID = loadImage("1.jpg")

def texCube():
	glBegin(GL_QUADS)
	glTexCoord2f(0.5, 0.5); glVertex3f( 1.0, -1.0, -1.0)
	glTexCoord2f(0.5, 0.75); glVertex3f( 1.0, 1.0, -1.0)
	glTexCoord2f(0.75, 0.75); glVertex3f( 1.0,  1.0,  1.0)
	...
	glTexCoord2f(0.0, 0.75); glVertex3f(-1.0,  1.0,  1.0)
	glTexCoord2f(0.25, 0.75); glVertex3f( -1.0,  1.0, -1.0)
	
	glTexCoord2f(1.0, 0.5); glVertex3f(-1.0, -1.0, 1.0)
	glTexCoord2f(1.0, 0.75); glVertex3f(-1.0, 1.0, 1.0)
	glTexCoord2f(0.75, 0.75); glVertex3f( 1.0, 1.0,  1.0)
	glTexCoord2f(0.75, 0.5); glVertex3f(1.0, -1.0,  1.0)
