...
line(width//4, height*2//3, width*3//4, height*2//3)
#line(width*2//5, height*3//4, width*3//5, height*3//4)
                
bezie((width//4, height*2//3), (width//3,height*2//3), (width//3,height//2), (width*5//12,height//2))
bezie((width*5//12,height//2), (width*11//24,height//2), (width//2,height*21//40), (width//2, height*11//20))
bezie((width//2, height*11//20), (width//2,height*21//40), (width*13//24,height//2), (width*7//12, height//2))
bezie((width*7//12, height//2), (width*2//3,height//2), (width*2//3,height*2//3), (width*3//4, height*2//3))
