...
bezie((width//2,height//4), (width//4,height//4), (width//4,height*3//4), (width//2,height*3//4))
bezie((width//2,height//4), (width*3//4,height//4), (width*3//4,height*3//4), (width//2,height*3//4))
image.show()
