...
for x in range(width1):
        for y in range(height1):
            ...
            b2 = pix2[x, y][1]
            c2 = pix2[x, y][2]
            if((x - width1//2)**2 + (y - height1//2)**2 >= (height1//2)**2):
...
for x in range(width1):
        for y in range(height1):
            ...
            b2 = pix2[x, y][1]
            c2 = pix2[x, y][2]
            if((x - width1//2)**2 + (y - height1//2)**2 < (height1//2)**2 and (x - width1//2)**2 + (y - height1//2)**2 >= (height1//3)**2):
                q = (x - (height1//3)**2)/((height1//2)**2 - (height1//3)**2)
