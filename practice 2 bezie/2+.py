...
#line(width*2//5, height//4, width*3//5, height//4)
#line(width*2//5, height*3//4, width*3//5, height*3//4)
                
bezie((width//2,height//10), (width//2,height*3//10), (width//4,height//10), (width//4,height*3//10))
bezie((width//2, height//10), (width//2,height*3//10), (width*3//4,height//10), (width*3//4, height*3//10))
bezie((width//4,height*3//10), (width//4,height*6//10), (width//2,height*6//10), (width//2,height*9//10))
bezie((width*3//4, height*3//10), (width*3//4,height*6//10), (width//2,height*6//10), (width//2,height*9//10))
